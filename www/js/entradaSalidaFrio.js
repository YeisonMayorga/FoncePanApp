import {obtenerProductos, obtenerEntradas, obtenerSalidas, agregarEntrada, agregarSalida, actualizarEntrada, eliminarEntrada, actualizarSalida, eliminarSalida, supabase, obtenerProductosUnd, obtenerStockProducto, obtenerPrueba } from './app.js';
let entradasGlobal = []; 
let salidasGlobal = [];
let entradas = [];
...
//  const columnasEntradas = [
  //  { data: 'fecha_entrada_formateada', title: 'Fecha' },
  //  { data: 'id', title: 'id' }
 // ];
const columnasEntradas = [
    { 
